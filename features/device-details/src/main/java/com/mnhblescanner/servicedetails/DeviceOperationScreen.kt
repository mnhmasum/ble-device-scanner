...
@Composable
fun DeviceOperationScreen(navController: NavController, deviceAddress: String) {
    ...
    serviceInfo?.let { DeviceInfo1(serviceInfo = it) }

}

@Composable
fun DeviceInfo1(serviceInfo: ServiceInfo) {
